...
public class apitask_technology extends Activity {
    EditText etResponse;
    ...
    public String GET(String url) {
        ...
        try {
            ...
            nameValuePairs.add(new BasicNameValuePair("module", "technology"));
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            ap.insertEntry("www.vocabmonk.com", "technology", result, 20);
            ap.close();
            finish();
            Intent i= new Intent(apitask_technology.this,MainActivity_technology.class);
            startActivity(i);
