...
public class apitask_speed extends Activity {
    EditText etResponse;
    ...
    public String GET(String url) {
        ...
        try {
            ...
            nameValuePairs.add(new BasicNameValuePair("module", "speed"));
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            ap.insertEntry("www.vocabmonk.com", "speed", result, 20);
            ap.close();
            finish();
            Intent i= new Intent(apitask_speed.this,MainActivity_speed.class);
            startActivity(i);
