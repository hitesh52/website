...
public class apitask1 extends Activity {
    String URL_website="WWW.rankatch.com";
    EditText etResponse;
   ...
   SMSBlockerDataBaseAdapter ap;
    ...
    public String GET(String url) {
        ...
        try {
            ...
            nameValuePairs.add(new BasicNameValuePair("module", "spell"));
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            ap.insertEntry("www.vocabmonk.com","spell",result,20);
            ap.close();
            finish();
            ...
            /*Log.v("hitesh", result);
            Intent i= new Intent(apitask1.this,MainActivity_spell.class);
