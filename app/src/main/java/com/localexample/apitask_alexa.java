...
public class apitask_alexa extends Activity {
    EditText etResponse;
    ...
    public String GET(String url) {
        ...
        try {
            ...
            nameValuePairs.add(new BasicNameValuePair("module", "alexa"));
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            ap.insertEntry("www.vocabmonk.com", "alexa", result, 20);
            ap.close();
            finish();
            Intent i= new Intent(apitask_alexa.this,MainActivity_alexa.class);
            startActivity(i);
